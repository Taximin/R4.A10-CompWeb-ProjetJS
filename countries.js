const countries = [{
    ...
    "regionalBlocs": [{
        "acronym": "AU",
        "name": "African Union",
        "otherNames": ["Ø§Ù„Ø§ØªØ­Ø§Ø¯ Ø§Ù„Ø£ÙØ±ÙŠÙ‚ÙŠ", "Union africaine", "UniÃ£o Africana", "UniÃ³n Africana", "Umoja wa Afrika"]
    }, {
        "acronym": "AL",
        "name": "Arab League",
    ...
    "regionalBlocs": [{
        ...
        "otherNames": ["Comunidad del Caribe", "CommunautÃ© CaribÃ©enne", "Caribische Gemeenschap"]
    }],
    "cioc": "ANT",
    "independent": true
}, {
    ...
    "callingCodes": ["374"],
    "capital": "Yerevan",
    "altSpellings": ["AM", "Hayastan", "Republic of Armenia", "Õ€Õ¡ÕµÕ¡Õ½Õ¿Õ¡Õ¶Õ« Õ€Õ¡Õ¶Ö€Õ¡ÕºÕ¥Õ¿Õ¸Ö‚Õ©ÕµÕ¸Ö‚Õ¶"],
    "region": "Western Asia",
    "continent": "Asia",
    "population": 2994400,
    "latlng": [40.0, 45.0],
    ...
    "callingCodes": ["375"],
    "capital": "Minsk",
    "altSpellings": ["BY", "BielaruÅ›", "Republic of Belarus", "Ð‘ÐµÐ»Ð¾Ñ€ÑƒÑÑÐ¸Ñ", "Ð ÐµÑÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ° Ð‘ÐµÐ»Ð°Ñ€ÑƒÑÑŒ", "Belorussiya", "Respublika Belarusâ€™"],
    ...
    "callingCodes": ["591"],
    "capital": "Sucre",
    "altSpellings": ["BO", "Buliwya", "Wuliwya", "Plurinational State of Bolivia", "Estado Plurinacional de Bolivia", "Buliwya Mamallaqta", "Wuliwya Suyu", "TetÃ£ VolÃ­via"],
    "region": "South America",
    "continent": "Americas",
    "population": 10985059,
    "latlng": [-17.0, -65.0],
    ...
    "callingCodes": ["55"],
    "capital": "BrasÃ­lia",
    "altSpellings": ["BR", "Brasil", "Federative Republic of Brazil", "RepÃºblica Federativa do Brasil"],
    "region": "South America",
    "continent": "Americas",
    ...
    "callingCodes": ["257"],
    "capital": "Bujumbura",
    "altSpellings": ["BI", "Republic of Burundi", "Republika y'Uburundi", "RÃ©publique du Burundi"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 10114505,
    "latlng": [-3.5, 30.0],
    ...
    "regionalBlocs": [{
        ...
        "otherNames": ["Tratado de Libre Comercio de AmÃ©rica del Norte", "Accord de Libre-Ã©change Nord-AmÃ©ricain"]
    }],
    "cioc": "CAN",
    "independent": true
}, {
    ...
    "callingCodes": ["86"],
    "capital": "Beijing",
    "altSpellings": ["CN", "ZhÅngguÃ³", "Zhongguo", "Zhonghua", "People's Republic of China", "ä¸­åŽäººæ°‘å…±å’Œå›½", "ZhÅnghuÃ¡ RÃ©nmÃ­n GÃ²nghÃ©guÃ³"],
    "region": "Eastern Asia",
    "continent": "Asia",
    ...
    "callingCodes": ["269"],
    "capital": "Moroni",
    "altSpellings": ["KM", "Union of the Comoros", "Union des Comores", "Udzima wa Komori", "al-Ittiá¸¥Äd al-QumurÄ«"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 806153,
    ...
    "callingCodes": ["599"],
    "capital": "Willemstad",
    "altSpellings": ["CW", "Curacao", "KÃ²rsou", "Country of CuraÃ§ao", "Land CuraÃ§ao", "Pais KÃ²rsou"],
    "region": "Caribbean",
    "continent": "Americas",
    "population": 154843,
    ...
    "callingCodes": ["357"],
    "capital": "Nicosia",
    "altSpellings": ["CY", "KÃ½pros", "KÄ±brÄ±s", "Republic of Cyprus", "ÎšÏ…Ï€ÏÎ¹Î±ÎºÎ® Î”Î·Î¼Î¿ÎºÏÎ±Ï„Î¯Î±", "KÄ±brÄ±s Cumhuriyeti"],
    "region": "Southern Europe",
    "continent": "Europe",
    "population": 847000,
    "latlng": [35.0, 33.0],
    ...
    "callingCodes": ["253"],
    "capital": "Djibouti",
    "altSpellings": ["DJ", "Jabuuti", "Gabuuti", "Republic of Djibouti", "RÃ©publique de Djibouti", "Gabuutih Ummuuno", "Jamhuuriyadda Jabuuti"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 900000,
    "latlng": [11.5, 43.0],
    ...
    "callingCodes": ["240"],
    "capital": "Malabo",
    "altSpellings": ["GQ", "Republic of Equatorial Guinea", "RepÃºblica de Guinea Ecuatorial", "RÃ©publique de GuinÃ©e Ã©quatoriale", "RepÃºblica da GuinÃ© Equatorial"],
    "region": "Middle Africa",
    "continent": "Africa",
    "population": 1222442,
    "latlng": [2.0, 10.0],
    ...
    "callingCodes": ["291"],
    "capital": "Asmara",
    "altSpellings": ["ER", "State of Eritrea", "áˆƒáŒˆáˆ¨ áŠ¤áˆ­á‰µáˆ«", "Dawlat IritriyÃ¡", "Ê¾ErtrÄ", "IritriyÄ", ""],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 5352000,
    "latlng": [15.0, 39.0],
    ...
    "callingCodes": ["251"],
    "capital": "Addis Ababa",
    "altSpellings": ["ET", "Ê¾ÄªtyÅá¹—á¹—yÄ", "Federal Democratic Republic of Ethiopia", "á‹¨áŠ¢á‰µá‹®áŒµá‹« áŒá‹´áˆ«áˆ‹á‹Š á‹²áˆžáŠ­áˆ«áˆ²á‹«á‹Š áˆªáá‰¥áˆŠáŠ­"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 92206005,
    "latlng": [8.0, 38.0],
    ...
    "callingCodes": ["30"],
    "capital": "Athens",
    "altSpellings": ["GR", "EllÃ¡da", "Hellenic Republic", "Î•Î»Î»Î·Î½Î¹ÎºÎ® Î”Î·Î¼Î¿ÎºÏÎ±Ï„Î¯Î±"],
    "region": "Southern Europe",
    "continent": "Europe",
    "population": 10858018,
    "latlng": [39.0, 22.0],
    ...
    "altSpellings": ["CI", "Ivory Coast", "Republic of CÃ´te d'Ivoire", "RÃ©publique de CÃ´te d'Ivoire"],
    "region": "Western Africa",
    "continent": "Africa",
    "population": 22671331,
    "latlng": [8.0, -5.0],
    ...
    "callingCodes": ["962"],
    "capital": "Amman",
    "altSpellings": ["JO", "Hashemite Kingdom of Jordan", "al-Mamlakah al-UrdunÄ«yah al-HÄshimÄ«yah"],
    "region": "Western Asia",
    "continent": "Asia",
    "population": 9531712,
    "latlng": [31.0, 36.0],
    ...
    "callingCodes": ["76", "77"],
    "capital": "Nursultan",
    "altSpellings": ["KZ", "Qazaqstan", "ÐšÐ°Ð·Ð°Ñ…ÑÑ‚Ð°Ð½", "Republic of Kazakhstan", "ÒšÐ°Ð·Ð°Ò›ÑÑ‚Ð°Ð½ Ð ÐµÑÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ°ÑÑ‹", "Qazaqstan RespublÃ¯kasÄ±", "Ð ÐµÑÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ° ÐšÐ°Ð·Ð°Ñ…ÑÑ‚Ð°Ð½", "Respublika Kazakhstan"],
    "region": "Central Asia",
    "continent": "Asia",
    "population": 17753200,
    "latlng": [48.0, 68.0],
    ...
    "callingCodes": ["996"],
    "capital": "Bishkek",
    "altSpellings": ["KG", "ÐšÐ¸Ñ€Ð³Ð¸Ð·Ð¸Ñ", "Kyrgyz Republic", "ÐšÑ‹Ñ€Ð³Ñ‹Ð· Ð ÐµÑÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ°ÑÑ‹", "Kyrgyz Respublikasy"],
    "region": "Central Asia",
    "continent": "Asia",
    "population": 6047800,
    "latlng": [41.0, 75.0],
    ...
    "callingCodes": ["352"],
    "capital": "Luxembourg",
    "altSpellings": ["LU", "Grand Duchy of Luxembourg", "Grand-DuchÃ© de Luxembourg", "GroÃŸherzogtum Luxemburg", "Groussherzogtum LÃ«tzebuerg"],
    "region": "Western Europe",
    "continent": "Europe",
    "population": 576200,
    ...
    "alpha3Code": "MAC",
    "callingCodes": ["853"],
    "altSpellings": ["MO", "æ¾³é—¨", "Macao Special Administrative Region of the People's Republic of China", "ä¸­è¯äººæ°‘å…±å’Œåœ‹æ¾³é–€ç‰¹åˆ¥è¡Œæ”¿å€", "RegiÃ£o Administrativa Especial de Macau da RepÃºblica Popular da China"],
    "region": "Eastern Asia",
    "continent": "Asia",
    "population": 649100,
    ...
    "altSpellings": ["MG", "Republic of Madagascar", "Repoblikan'i Madagasikara", "RÃ©publique de Madagascar"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 22434363,
    "latlng": [-20.0, 47.0],
    ...
    "callingCodes": ["222"],
    "capital": "Nouakchott",
    "altSpellings": ["MR", "Islamic Republic of Mauritania", "al-JumhÅ«riyyah al-Ê¾IslÄmiyyah al-MÅ«rÄ«tÄniyyah"],
    "region": "Western Africa",
    "continent": "Africa",
    "population": 3718678,
    "latlng": [20.0, -12.0],
    ...
    "callingCodes": ["95"],
    "capital": "Naypyidaw",
    "altSpellings": ["MM", "Burma", "Republic of the Union of Myanmar", "Pyidaunzu ThanmÄƒda MyÄƒma Nainngandaw"],
    "region": "South-Eastern Asia",
    "continent": "Asia",
    "population": 51419420,
    "latlng": [22.0, 98.0],
    ...
    "callingCodes": ["977"],
    "capital": "Kathmandu",
    "altSpellings": ["NP", "Federal Democratic Republic of Nepal", "LoktÄntrik Ganatantra NepÄl"],
    "region": "Southern Asia",
    "continent": "Asia",
    "population": 28431500,
    "latlng": [28.0, 84.0],
    ...
    "callingCodes": ["850"],
    "capital": "Pyongyang",
    "altSpellings": ["KP", "Democratic People's Republic of Korea", "ì¡°ì„ ë¯¼ì£¼ì£¼ì˜ì¸ë¯¼ê³µí™”êµ­", "ChosÅn MinjujuÅ­i Inmin Konghwaguk"],
    "region": "Eastern Asia",
    "continent": "Asia",
    "population": 25281000,
    "latlng": [40.0, 127.0],
    ...
    "callingCodes": ["1"],
    "capital": "Saipan",
    "altSpellings": ["MP", "Commonwealth of the Northern Mariana Islands", "Sankattan Siha Na Islas MariÃ¥nas"],
    "region": "Micronesia",
    "continent": "Oceania",
    "population": 56940,
    "latlng": [15.2, 145.75],
    ...
    "callingCodes": ["92"],
    "capital": "Islamabad",
    "altSpellings": ["PK", "PÄkistÄn", "Islamic Republic of Pakistan", "IslÄmÄ« JumhÅ«riya'eh PÄkistÄn"],
    "region": "Southern Asia",
    "continent": "Asia",
    ...
    "callingCodes": ["7"],
    "capital": "Moscow",
    "altSpellings": ["RU", "Rossiya", "Russian Federation", "Ð Ð¾ÑÑÐ¸Ð¹ÑÐºÐ°Ñ Ð¤ÐµÐ´ÐµÑ€Ð°Ñ†Ð¸Ñ", "Rossiyskaya Federatsiya"],
    "region": "Eastern Europe",
    "continent": "Europe",
    ...
    "callingCodes": ["250"],
    "capital": "Kigali",
    "altSpellings": ["RW", "Republic of Rwanda", "Repubulika y'u Rwanda", "RÃ©publique du Rwanda"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 11553188,
    "latlng": [-2.0, 30.0],
    ...
    "callingCodes": ["590"],
    "capital": "Gustavia",
    "altSpellings": ["BL", "St. Barthelemy", "Collectivity of Saint BarthÃ©lemy", "CollectivitÃ© de Saint-BarthÃ©lemy"],
    "region": "Caribbean",
    "continent": "Americas",
    "population": 9417,
    ...
    "callingCodes": ["239"],
    "capital": "SÃ£o TomÃ©",
    "altSpellings": ["ST", "Democratic Republic of SÃ£o TomÃ© and PrÃ­ncipe", "RepÃºblica DemocrÃ¡tica de SÃ£o TomÃ© e PrÃ­ncipe"],
    "region": "Middle Africa",
    "continent": "Africa",
    "population": 187356,
    "latlng": [1.0, 7.0],
    ...
    "callingCodes": ["966"],
    "capital": "Riyadh",
    "altSpellings": ["SA", "Kingdom of Saudi Arabia", "Al-Mamlakah al-â€˜Arabiyyah as-Suâ€˜Å«diyyah"],
    "region": "Western Asia",
    "continent": "Asia",
    "population": 32248200,
    "latlng": [25.0, 45.0],
    ...
    "callingCodes": ["381"],
    "capital": "Belgrade",
    "altSpellings": ["RS", "Srbija", "Republic of Serbia", "Ð ÐµÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ° Ð¡Ñ€Ð±Ð¸Ñ˜Ð°", "Republika Srbija"],
    "region": "Southern Europe",
    "continent": "Europe",
    "population": 7076372,
    "latlng": [44.0, 21.0],
    ...
    "callingCodes": ["248"],
    "capital": "Victoria",
    "altSpellings": ["SC", "Republic of Seychelles", "Repiblik Sesel", "RÃ©publique des Seychelles"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 91400,
    ...
    "callingCodes": ["252"],
    "capital": "Mogadishu",
    "altSpellings": ["SO", "aá¹£-á¹¢Å«mÄl", "Federal Republic of Somalia", "Jamhuuriyadda Federaalka Soomaaliya", "JumhÅ«riyyat aá¹£-á¹¢Å«mÄl al-FiderÄliyya"],
    "region": "Eastern Africa",
    "continent": "Africa",
    "population": 11079000,
    "latlng": [10.0, 49.0],
    ...
    "callingCodes": ["886"],
    "capital": "Taipei",
    "altSpellings": ["TW", "TÃ¡iwÄn", "Republic of China", "ä¸­è¯æ°‘åœ‹", "ZhÅnghuÃ¡ MÃ­nguÃ³"],
    "region": "Eastern Asia",
    "continent": "Asia",
    "population": 23503349,
    "latlng": [23.5, 121.0],
    ...
    "callingCodes": ["992"],
    "capital": "Dushanbe",
    "altSpellings": ["TJ", "ToÃ§ikiston", "Republic of Tajikistan", "Ò¶ÑƒÐ¼Ò³ÑƒÑ€Ð¸Ð¸ Ð¢Ð¾Ò·Ð¸ÐºÐ¸ÑÑ‚Ð¾Ð½", "Ã‡umhuriyi ToÃ§ikiston"],
    "region": "Central Asia",
    "continent": "Asia",
    "population": 8593600,
    "latlng": [39.0, 71.0],
    ...
    "callingCodes": ["66"],
    "capital": "Bangkok",
    "altSpellings": ["TH", "Prathet", "Thai", "Kingdom of Thailand", "à¸£à¸²à¸Šà¸­à¸²à¸“à¸²à¸ˆà¸±à¸à¸£à¹„à¸—à¸¢", "Ratcha Anachak Thai"],
    "region": "South-Eastern Asia",
    "continent": "Asia",
    "population": 65327652,
    "latlng": [15.0, 100.0],
    ...
    "callingCodes": ["670"],
    "capital": "Dili",
    "altSpellings": ["TL", "East Timor", "Democratic Republic of Timor-Leste", "RepÃºblica DemocrÃ¡tica de Timor-Leste", "RepÃºblika DemokrÃ¡tika TimÃ³r-Leste"],
    "region": "South-Eastern Asia",
    "continent": "Asia",
    "population": 1167242,
    ...
    "callingCodes": ["998"],
    "capital": "Tashkent",
    "altSpellings": ["UZ", "Republic of Uzbekistan", "Oâ€˜zbekiston Respublikasi", "ÐŽÐ·Ð±ÐµÐºÐ¸ÑÑ‚Ð¾Ð½ Ð ÐµÑÐ¿ÑƒÐ±Ð»Ð¸ÐºÐ°ÑÐ¸"],
    "region": "Central Asia",
    "continent": "Asia",
    "population": 31576400,
    "latlng": [41.0, 64.0],
    ...
    "callingCodes": ["678"],
    "capital": "Port Vila",
    "altSpellings": ["VU", "Republic of Vanuatu", "Ripablik blong Vanuatu", "RÃ©publique de Vanuatu"],
    "region": "Melanesia",
    "continent": "Oceania",
    "population": 277500,
    "latlng": [-16.0, 167.0],
    ...
    "callingCodes": ["58"],
    "capital": "Caracas",
    "altSpellings": ["VE", "Bolivarian Republic of Venezuela", "RepÃºblica Bolivariana de Venezuela"],
    "region": "South America",
    "continent": "Americas",
    "population": 31028700,
    "latlng": [8.0, -66.0],
    ...
    "callingCodes": ["84"],
    "capital": "Hanoi",
    "altSpellings": ["VN", "Socialist Republic of Vietnam", "Cá»™ng hÃ²a XÃ£ há»™i chá»§ nghÄ©a Viá»‡t Nam"],
    "region": "South-Eastern Asia",
    "continent": "Asia",
    "population": 92700000,
    ...
    "callingCodes": ["681"],
    "capital": "Mata-Utu",
    "altSpellings": ["WF", "Territory of the Wallis and Futuna Islands", "Territoire des Ã®les Wallis et Futuna"],
    "region": "Polynesia",
    "continent": "Oceania",
    "population": 11750,
    "latlng": [-13.3, -176.2],
